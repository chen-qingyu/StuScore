		...
		<div class="main-right">
			...
			<div class="panel">
				<div class="panel-desc">
					...
					<span class="main-nav-active">
						<a href="/stuscore/type?action=page&pageIndex=1&pageSize=10">考试类型管理</a>
					</span>
					<span class="main-nav-sep">
						/
					</span>
			...
			<div class="panel">
				<div class="panel-desc">
					<form class="form-edit" action="/stuscore/type?action=upd" method="post">
						...
						<div class="form-input">
							...
							<textarea  name="comm" cols="90" rows="5">${type.comm }</textarea>
						</div>
