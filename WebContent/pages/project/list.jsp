						...
						<c:choose>
							<c:when test="${index == page.pageIndex }">
								<li class="page-panel-this">
									<a href="/stuscore/project?action=page&pageIndex=${index }&pageSize=${page.pageSize }">${index }</a>
								</li>
							</c:when>
							<c:otherwise>
								<li>
	...
	<script type="text/javascript">
		$(function(){
			...
			$(".btn-search").on("click", function(e){
				...
				window.location.href = "/stuscore/project?action=page&pageIndex=1&pageSize=10&name=" + qryText;
			});
			
			// 添加按钮绑定
			$(".btn-add").on("click", function(e){
				
				window.location.href = "/stuscore/pages/project/add.jsp";
			});
			...
			$(".btn-edit").on("click", function(e){
				...
				window.location.href = "/stuscore/project?action=info&id=" + id;
			});
			...
			$(".btn-del").on("click", function(){
				...
				window.location.href = "/stuscore/project?action=del&id=" + id;
			});
		});
	</script>
</body>
